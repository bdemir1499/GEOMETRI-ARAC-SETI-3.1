...
window.GonyeTool.finalizeDraw = function() {
    ...
    if (window.drawnStrokes && window.redrawAllStrokes) {
        // DEĞİŞİKLİK BURADA: Harf atama kodlarını kaldırdık ve tipi 'straightLine' yaptık.
        
        window.drawnStrokes.push({
            type: 'straightLine', // <-- 'segment' yerine 'straightLine'
            p1: p1,
            p2: p2,
            color: window.isToolThemeBlack ? '#000000' : window.currentLineColor, 
            width: 3,
            // label1 ve label2 kaldırıldı (Düz çizgide nokta ismi olmaz)
            lengthLabel: cmText, 
